...
if ($_SESSION['login'] != "true") {
  ...
  if (isset($_GET['remove'])) {
    ...
    header('location: konfirmasipinjam.php?barang='.$newbarang);
  }
...
<section class="py-5 mb-4">
    <div class="container">
        ...
        <ul class="list-unstyled">
            ...
            <li class="media mb-3">
                ...
                <div class="media-body">
                    ...
                    <a href="konfirmasipinjam.php?barang=<?= $barang ?>&remove=<?= $result['id_barang'] ?>"><button
        ...
        <hr>
        <h3 class="text-white">Data Lanjutan</h3>
        <br>
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    <label for="tanggal_pinjam" class="text-white">Tanggal Peminjaman</label>
                    <input type="date" class="bg-white rounded-10 shadow text-center p-2 pe-3 ps-3 border-0" id="tanggal_pinjam"
                        placeholder="Masukan Tanggal Peminjaman">
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label for="tanggal_pengembalian" class="text-white">Tanggal Pengembalian</label>
                    <input type="date" class="bg-white rounded-10 shadow text-center p-2 pe-3 ps-3 border-0" id="tanggal_pengembalian"
                        placeholder="Masukan Tanggal Pengembalian">
                </div>
            </div>
        </div>
        <hr>
        <a class="float-left btn btn-secondary" href="dashboard.php"><i class="fas fa-fw fa-arrow-left"></i> kembali</a>
    ...
    <div class="modal-dialog  modal-dialog-centered" role="document">
        <div class="modal-content " style="background-color: #E2E2E2;">
            <div class="modal-header border-0">
                <h3 class="modal-title m-auto" id="exampleModalLabel"></h3>
                </button>
            </div>
            <div class="modal-body text-center">
                <h5>

                    Terimakasih, peminjaman telah diproses.Harap segera datang ke Pondok Cemara untuk mengambil barang.
                    dan jangan lupa dikembalikan:)
                </h5>
            </div>
            <div class="modal-footer border-0">
                <button id='konfirmasi_peminjaman' class="btn m-auto bg-gradient-success" >SELESAI !</button>
            </div>
        </div>
    </div>
</div>
